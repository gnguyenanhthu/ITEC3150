package edu.ggc.edu;// Stuart Reges / Marty Stepp
...
public class IntTree {
  ...
  /// YOUR CODE HERE
    public int sumNodes() { return sumNodes(overallRoot); }
    ...
    public int countLeftNodes() { return countLeftNodes(overallRoot); }
  	protected int countLeftNodes(IntTreeNode root)
  	{
  		// add code her to count how many left children are in the tree.  A left child is a node
  		// that appears as the root of the left-hand subtree of another node.  An empty tree has 0 left nodes.
